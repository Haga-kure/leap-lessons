...
const passwordCheck = (password, repassword) => {
  ...
  for (const char of password.split("")) {
    ...
    if (!containsChart) containsChart = SPECIALS.includes(char);
  }
...
const digitTarget = document.querySelector("#chart");
const chartTarget = document.querySelector("length");
